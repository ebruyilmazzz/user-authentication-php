    ...
    <div class="row">
      <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
          <h2>Kayıt Ol</h2>
          <p>Formu doldurarak kayıt olabilirsiniz</p>
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <div class="form-group">
              <label for="confirm_password">Parola Onay</label>
            ...
            <div class="form-row">
              <div class="col">
                <input type="submit" value="Kayıt Ol" class="btn btn-success btn-block">
              </div>
              <div class="col">
                <a href="login.php" class="btn btn-light btn-block">Hesabınız var mı? Giriş Yap</a>
              </div>
            </div>
          </form>
        </div>
